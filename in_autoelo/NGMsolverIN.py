...
elo_path = os.path.abspath("in_elos.json")
txtelo_path = os.path.abspath("in_TL.txt")
players_path = os.path.abspath("players.txt")
codes_path = os.path.abspath("codes.txt")
watched_data_fallback = os.path.abspath("in_clean.csv")
watched_data_fallback_year = os.path.abspath("in_clean_year.csv")
