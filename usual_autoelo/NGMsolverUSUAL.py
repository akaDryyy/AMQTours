...
from TierMakerUSUAL import trim, compute_rank_scores
...
elo_path = os.path.abspath("usual_elos.json")
txtelo_path = os.path.abspath("usual_TL.txt")
players_path = os.path.abspath("players.txt")
codes_path = os.path.abspath("codes.txt")
watched_data_fallback = os.path.abspath("usual_clean.csv")
watched_data_fallback_year = os.path.abspath("usual_clean_year.csv")
