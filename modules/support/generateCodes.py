...
def generate_codes_watched_ed_gr(_, txtvar):
    txtvar += "\n<YOURCHALLONGEURLHERE>\n"
    txtvar += "```j0g0z211111001130z000010100000000z11111111111100k051o000000f111100k012r02i0a46533a11002s01111111111100140111002s01a111111111102a111111111050017pr11hg1ka03-11111--```\n"
    txtvar += """Distribution of guesses:
≥28% = 5 guesses
18% - 28% = 4 guesses
12% - 18% = 3 guesses
...
def generate_codes_watched_op_gr(_, txtvar):
    txtvar += "\n<YOURCHALLONGEURLHERE>\n"
    txtvar += "```j0g0z211111001130z000011000000000z11111111111100k051o000000f111100k012r02i0a46533a11002s01111111111100140111002s01a111111111102a111111111050017pr11hg1ka03-11111--```\n"
    txtvar += """Distribution of guesses:
≥28% = 5 guesses
18% - 28% = 4 guesses
12% - 18% = 3 guesses
...
def generate_codes_watched_oped_gr(_, txtvar):
    txtvar += "\n<YOURCHALLONGEURLHERE>\n"
    txtvar += "```m0g0z2111110011130z000011100000000z11111111111100k051o000000f152143331110000k012r02i0a46533a11002s01111111111100140111002s01a111111111102a111111111050017pr11hg1ka03-11111--```\n"
    txtvar += """Distribution of guesses:
≥28% = 5 guesses
18% - 28% = 4 guesses
12% - 18% = 3 guesses
