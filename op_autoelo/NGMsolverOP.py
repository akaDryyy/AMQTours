...
from TierMakerOP import trim, compute_rank_scores
...
elo_path = os.path.abspath("op_elos.json")
txtelo_path = os.path.abspath("op_TL.txt")
players_path = os.path.abspath("players.txt")
codes_path = os.path.abspath("codes.txt")
watched_data_fallback = os.path.abspath("op_clean.csv")
watched_data_fallback_year = os.path.abspath("op_clean_year.csv")
