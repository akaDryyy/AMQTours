...
from TierMakerED import trim, compute_rank_scores
...
elo_path = os.path.abspath("ed_elos.json")
txtelo_path = os.path.abspath("ed_TL.txt")
players_path = os.path.abspath("players.txt")
codes_path = os.path.abspath("codes.txt")
watched_data_fallback = os.path.abspath("ed_clean.csv")
watched_data_fallback_year = os.path.abspath("ed_clean_year.csv")
